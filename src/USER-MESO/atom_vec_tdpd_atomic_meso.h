...
AtomStyle(tdpd/atomic/meso,AtomVecTDPDAtomic)

#else

#ifndef LMP_MESO_ATOM_VEC_TDPD_ATOMIC
#define LMP_MESO_ATOM_VEC_TDPD_ATOMIC
...
class AtomVecTDPDAtomic: public AtomVecDPDAtomic
{
public:
    AtomVecTDPDAtomic(LAMMPS *lmp);
    ~AtomVecTDPDAtomic() {}
